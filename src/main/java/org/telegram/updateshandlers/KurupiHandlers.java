 ...
 */
public class KurupiHandlers extends TelegramLongPollingBot {
    ...
    private static final String helpMessage = "Este bot puede ayudarte a buscar definiciones de palabras según el diccionario de la RAE.\n\n" +
            ...
            "Simplemente abre cualquiera de tus chats y escribe `@KurupiBot loquesea` en la zona de escribir mensajes.\n" +
            "Finalmente pulsa sobre un resultado para enviarlo." +
            "\n\n" +
            "Por ejemplo, intenta escribir `@KurupiBot Punto` aquí.";

    @Override
    public String getBotToken() {
        return BotConfig.KURUPI_TOKEN;
    }
